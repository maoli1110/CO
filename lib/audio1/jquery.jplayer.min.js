/*! jPlayer 2.9.2 for jQuery ~ (c) 2009-2014 Happyworm Ltd ~ MIT License */ ! function(a, b) {
	...
	a.jPlayer.keys = function(b) {
		...
		_updateInterface: function() {
			// console.log(this.css.jq.seekBar.length);
			this.css.jq.seekBar.length && this.css.jq.seekBar.width(100 + "%"), this.css.jq.playBar.length && (this.options.smoothPlayBar ? this.css.jq.playBar.stop().animate({
			...
			this.css.jq.duration.length && ("string" == typeof this.status.media.duration ? b = this.status.media.duration : ("number" == typeof this.status.media.duration && (c = this.status.media.duration, d = c - this.status.currentTime), b = this._convertTime(c), b !== this.css.jq.duration.text() && this.css.jq.duration.text(b))
		},
