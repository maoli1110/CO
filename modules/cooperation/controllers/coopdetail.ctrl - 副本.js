 ...
 * coopdetailCtrl
 */
angular.module('cooperation').controller('coopdetailCtrl', ['$scope', '$http', '$uibModal','$httpParamSerializer','FileUploader','Cooperation','$state','$stateParams','Manage','$sce','$timeout','Common','Communication',
    function ($scope, $http, $uibModal, $httpParamSerializer,FileUploader,Cooperation,$state,$stateParams,Manage,$sce,$timeout,Common,Communication) {
...
//	            console.log('restore');
	    ...
	    //详情页面跳转回homepage(cooperation)
	   	$scope.backCooperation = function (){
	   		...
	   		$state.go('cooperation',{'deptId':$scope.collaList.deptId, 'ppid':$scope.collaList.ppid,'status':$scope.collaList.statusId,'source':'detail'},{ location: 'replace'});
	   	}
